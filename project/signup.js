...
//     let storageEmail = emailIndex(arrayToStorage);
//     let storagePassword = passwordIndex(arrayToStorage);


//     function emailIndex(arr){
//         let testArrayEmail = arr.map(function (key){
...
//     function passwordIndex(arr){
//         let testArrayPassword = arr.map(function (key){
//             return key.password
//         })
//         return testArrayPassword
//     }
...
//     let toChangePasswordinJSON = JSON.stringify(storagePassword)

//     if (toChangePasswordinJSON.match(valueFromPasswordLog) && valueFromPasswordLog !==""){
